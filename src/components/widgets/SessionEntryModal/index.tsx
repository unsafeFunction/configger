...
const SessionEntryModal = (): JSX.Element => {
  ...
  return (
    <div className={styles.sessionInfoModal}>
      ...
      <p>
        The session has a time limit set on the scanner, as shown in the upper
        right corner. After the limit expires, the session will end. Scans are
        only accepted during a session, and any scans performed outside a
